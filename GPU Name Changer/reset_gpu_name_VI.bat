...
echo   %ESC%[93m[2] %ESC%[92mReset ten GPU ve mac dinh%ESC%[0m
...
cls
echo ================================================
echo            RESET TEN GPU VE MAC DINH
echo ================================================
echo.
...
echo.
echo %ESC%[93mDa reset ten GPU ve mac dinh thanh cong!%ESC%[0m
echo Co the can restart de ten hien thi cap nhat lai day du.
pause
goto MENU
